...
typedef uint16_t P1588_MPLS_LABEL_LSB_VALUE_TYPE;
#define P1588_MPLS_LABEL_LSB_VALUE_VALUE_MASK (0xffffU)
#define P1588_MPLS_LABEL_LSB_VALUE_VALUE_SHIFT (0U)
...
typedef volatile struct COMP_PACKED _P1588_RDBType {
    ...
    P1588_TX_MODE_TYPE tx_mode_port_1; /* OFFSET: 0x24 */
    P1588_TX_MODE_TYPE tx_mode_port_2; /* OFFSET: 0x26 */
    P1588_TX_MODE_TYPE tx_mode_port_3; /* OFFSET: 0x28 */
    P1588_TX_MODE_TYPE tx_mode_port_4; /* OFFSET: 0x2a */
    P1588_TX_MODE_TYPE tx_mode_port_5; /* OFFSET: 0x2c */
    P1588_TX_MODE_TYPE tx_mode_port_6; /* OFFSET: 0x2e */
    P1588_TX_MODE_TYPE tx_mode_port_7; /* OFFSET: 0x30 */
    P1588_RX_MODE_TYPE rx_mode_port_0; /* OFFSET: 0x32 */
    P1588_RX_MODE_TYPE rx_mode_port_1; /* OFFSET: 0x34 */
    P1588_RX_MODE_TYPE rx_mode_port_2; /* OFFSET: 0x36 */
    P1588_RX_MODE_TYPE rx_mode_port_3; /* OFFSET: 0x38 */
    P1588_RX_MODE_TYPE rx_mode_port_4; /* OFFSET: 0x3a */
    P1588_RX_MODE_TYPE rx_mode_port_5; /* OFFSET: 0x3c */
    P1588_RX_MODE_TYPE rx_mode_port_6; /* OFFSET: 0x3e */
    P1588_RX_MODE_TYPE rx_mode_port_7; /* OFFSET: 0x40 */
    ...
    P1588_RX_PORT_LINK_DELAY_LSB_TYPE rx_port_1_link_delay_lsb; /* OFFSET: 0x4c */
    P1588_RX_PORT_LINK_DELAY_MSB_TYPE rx_port_1_link_delay_msb; /* OFFSET: 0x4e */
    P1588_RX_PORT_LINK_DELAY_LSB_TYPE rx_port_2_link_delay_lsb; /* OFFSET: 0x50 */
    P1588_RX_PORT_LINK_DELAY_MSB_TYPE rx_port_2_link_delay_msb; /* OFFSET: 0x52 */
    P1588_RX_PORT_LINK_DELAY_LSB_TYPE rx_port_3_link_delay_lsb; /* OFFSET: 0x54 */
    P1588_RX_PORT_LINK_DELAY_MSB_TYPE rx_port_3_link_delay_msb; /* OFFSET: 0x56 */
    P1588_RX_PORT_LINK_DELAY_LSB_TYPE rx_port_4_link_delay_lsb; /* OFFSET: 0x58 */
    P1588_RX_PORT_LINK_DELAY_MSB_TYPE rx_port_4_link_delay_msb; /* OFFSET: 0x5a */
    P1588_RX_PORT_LINK_DELAY_LSB_TYPE rx_port_5_link_delay_lsb; /* OFFSET: 0x5c */
    P1588_RX_PORT_LINK_DELAY_MSB_TYPE rx_port_5_link_delay_msb; /* OFFSET: 0x5e */
    P1588_RX_PORT_LINK_DELAY_LSB_TYPE rx_port_6_link_delay_lsb; /* OFFSET: 0x60 */
    P1588_RX_PORT_LINK_DELAY_MSB_TYPE rx_port_6_link_delay_msb; /* OFFSET: 0x62 */
    P1588_RX_PORT_LINK_DELAY_LSB_TYPE rx_port_7_link_delay_lsb; /* OFFSET: 0x64 */
    P1588_RX_PORT_LINK_DELAY_MSB_TYPE rx_port_7_link_delay_msb; /* OFFSET: 0x66 */
    ...
    P1588_TX_PORT_TS_OFFSET_LSB_TYPE tx_port_1_ts_offset_lsb; /* OFFSET: 0x6c */
    P1588_TX_PORT_TS_OFFSET_MSB_TYPE tx_port_1_ts_offset_msb; /* OFFSET: 0x6e */
    P1588_TX_PORT_TS_OFFSET_LSB_TYPE tx_port_2_ts_offset_lsb; /* OFFSET: 0x70 */
    P1588_TX_PORT_TS_OFFSET_MSB_TYPE tx_port_2_ts_offset_msb; /* OFFSET: 0x72 */
    P1588_TX_PORT_TS_OFFSET_LSB_TYPE tx_port_3_ts_offset_lsb; /* OFFSET: 0x74 */
    P1588_TX_PORT_TS_OFFSET_MSB_TYPE tx_port_3_ts_offset_msb; /* OFFSET: 0x76 */
    P1588_TX_PORT_TS_OFFSET_LSB_TYPE tx_port_4_ts_offset_lsb; /* OFFSET: 0x78 */
    P1588_TX_PORT_TS_OFFSET_MSB_TYPE tx_port_4_ts_offset_msb; /* OFFSET: 0x7a */
    P1588_TX_PORT_TS_OFFSET_LSB_TYPE tx_port_5_ts_offset_lsb; /* OFFSET: 0x7c */
    P1588_TX_PORT_TS_OFFSET_MSB_TYPE tx_port_5_ts_offset_msb; /* OFFSET: 0x7e */
    P1588_TX_PORT_TS_OFFSET_LSB_TYPE tx_port_6_ts_offset_lsb; /* OFFSET: 0x80 */
    P1588_TX_PORT_TS_OFFSET_MSB_TYPE tx_port_6_ts_offset_msb; /* OFFSET: 0x82 */
    P1588_TX_PORT_TS_OFFSET_LSB_TYPE tx_port_7_ts_offset_lsb; /* OFFSET: 0x84 */
    P1588_TX_PORT_TS_OFFSET_MSB_TYPE tx_port_7_ts_offset_msb; /* OFFSET: 0x86 */
    ...
    P1588_RX_PORT_TS_OFFSET_LSB_TYPE rx_port_1_ts_offset_lsb; /* OFFSET: 0x8c */
    P1588_RX_PORT_TS_OFFSET_MSB_TYPE rx_port_1_ts_offset_msb; /* OFFSET: 0x8e */
    P1588_RX_PORT_TS_OFFSET_LSB_TYPE rx_port_2_ts_offset_lsb; /* OFFSET: 0x90 */
    P1588_RX_PORT_TS_OFFSET_MSB_TYPE rx_port_2_ts_offset_msb; /* OFFSET: 0x92 */
    P1588_RX_PORT_TS_OFFSET_LSB_TYPE rx_port_3_ts_offset_lsb; /* OFFSET: 0x94 */
    P1588_RX_PORT_TS_OFFSET_MSB_TYPE rx_port_3_ts_offset_msb; /* OFFSET: 0x96 */
    P1588_RX_PORT_TS_OFFSET_LSB_TYPE rx_port_4_ts_offset_lsb; /* OFFSET: 0x98 */
    P1588_RX_PORT_TS_OFFSET_MSB_TYPE rx_port_4_ts_offset_msb; /* OFFSET: 0x9a */
    P1588_RX_PORT_TS_OFFSET_LSB_TYPE rx_port_5_ts_offset_lsb; /* OFFSET: 0x9c */
    P1588_RX_PORT_TS_OFFSET_MSB_TYPE rx_port_5_ts_offset_msb; /* OFFSET: 0x9e */
    P1588_RX_PORT_TS_OFFSET_LSB_TYPE rx_port_6_ts_offset_lsb; /* OFFSET: 0xa0 */
    P1588_RX_PORT_TS_OFFSET_MSB_TYPE rx_port_6_ts_offset_msb; /* OFFSET: 0xa2 */
    P1588_RX_PORT_TS_OFFSET_LSB_TYPE rx_port_7_ts_offset_lsb; /* OFFSET: 0xa4 */
    P1588_RX_PORT_TS_OFFSET_MSB_TYPE rx_port_7_ts_offset_msb; /* OFFSET: 0xa6 */
    ...
    P1588_RESERVED_TYPE rsvd1[84]; /* OFFSET: 0x11e */
    P1588_MPLS_LABEL_LSB_VALUE_TYPE mpls_label9_lsb_value; /* OFFSET: 0x172 */
    P1588_RESERVED_TYPE rsvd2[18]; /* OFFSET: 0x174 */
    P1588_TIMECODE_SEL_TYPE timecode_sel; /* OFFSET: 0x186 */
    P1588_TIME_STAMP_3_TYPE time_stamp_3; /* OFFSET: 0x188 */
    P1588_RESERVED_TYPE rsvd3[78]; /* OFFSET: 0x18a */
    ...
    P1588_INBAND_CNTL_TYPE inband_cntl_1; /* OFFSET: 0x1de */
    P1588_INBAND_CNTL_TYPE inband_cntl_2; /* OFFSET: 0x1e0 */
    P1588_INBAND_CNTL_TYPE inband_cntl_3; /* OFFSET: 0x1e2 */
    P1588_INBAND_CNTL_TYPE inband_cntl_4; /* OFFSET: 0x1e4 */
    P1588_INBAND_CNTL_TYPE inband_cntl_5; /* OFFSET: 0x1e6 */
    P1588_INBAND_CNTL_TYPE inband_cntl_6; /* OFFSET: 0x1e8 */
    P1588_INBAND_CNTL_TYPE inband_cntl_7; /* OFFSET: 0x1ea */
...
#define P1588_8P_BASE                   (0x4A860000UL)
...
#define P1588_0_BASE                    (P1588_8P_BASE)


#define P1588_1P_BASE                   (0x4a860400)


#define P1588_1_BASE                    (P1588_1P_BASE)


#define P1588_MAX_TIMEHW_ID             (2UL)
...
#define P1588_PORT_MASK                 (0x01FFUL)


#define IO_P1588_SYNC_GEN_HW0_IN1_MASK  (IO_P1588_SYNC_GEN_IN1_8P_MASK)


#define IO_P1588_SYNC_GEN_HW0_IN0_MASK  (IO_P1588_SYNC_GEN_IN0_8P_MASK)


#define IO_P1588_SYNC_GEN_HW1_IN1_MASK  (IO_P1588_SYNC_GEN_IN1_1P_MASK)


#define IO_P1588_SYNC_GEN_HW1_IN0_MASK  (IO_P1588_SYNC_GEN_IN0_1P_MASK)
