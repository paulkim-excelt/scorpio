...
#define DMU_PWD_BLK2_SPI2_MASK (0x100UL)
#define DMU_PWD_BLK2_SPI2_SHIFT (8UL)
...
typedef volatile struct COMP_PACKED _DMU_RDBType {
    ...
    DMU_RESERVED_TYPE rsvd1[108]; /* OFFSET: 0x54 */
