...
typedef uint16_t BRPHY_CORE_EXPF5_TYPE;
#define BRPHY_CORE_EXPF5_BLK_TX_AT_CRC_COPPER_MASK (0x8000U)
#define BRPHY_CORE_EXPF5_BLK_TX_AT_CRC_COPPER_SHIFT (15U)
#define BRPHY_CORE_EXPF5_BLK_TX_AT_CRC_FIBER_MASK (0x4000U)
#define BRPHY_CORE_EXPF5_BLK_TX_AT_CRC_FIBER_SHIFT (14U)
#define BRPHY_CORE_EXPF5_BLK_RX_AT_CRC_COPPER_MASK (0x2000U)
#define BRPHY_CORE_EXPF5_BLK_RX_AT_CRC_COPPER_SHIFT (13U)
#define BRPHY_CORE_EXPF5_BLK_RX_AT_CRC_FIBER_MASK (0x1000U)
#define BRPHY_CORE_EXPF5_BLK_RX_AT_CRC_FIBER_SHIFT (12U)
#define BRPHY_CORE_EXPF5_RX_SOP_SEL_MASK (0xc00U)
#define BRPHY_CORE_EXPF5_RX_SOP_SEL_SHIFT (10U)
#define BRPHY_CORE_EXPF5_RX_SOP_SEL_OV_MASK (0x200U)
#define BRPHY_CORE_EXPF5_RX_SOP_SEL_OV_SHIFT (9U)
#define BRPHY_CORE_EXPF5_TX_SOP_10BT_ENABLE_MASK (0x100U)
#define BRPHY_CORE_EXPF5_TX_SOP_10BT_ENABLE_SHIFT (8U)
#define BRPHY_CORE_EXPF5_RX_SOP_10BT_ENABLE_MASK (0x80U)
#define BRPHY_CORE_EXPF5_RX_SOP_10BT_ENABLE_SHIFT (7U)
#define BRPHY_CORE_EXPF5_TX_SOP_ERR_STATUS_MASK (0x40U)
#define BRPHY_CORE_EXPF5_TX_SOP_ERR_STATUS_SHIFT (6U)
#define BRPHY_CORE_EXPF5_USE_TXEN_TX_SOP_MASK (0x20U)
#define BRPHY_CORE_EXPF5_USE_TXEN_TX_SOP_SHIFT (5U)
#define BRPHY_CORE_EXPF5_RX_SOP_ERR_STATUS_MASK (0x10U)
#define BRPHY_CORE_EXPF5_RX_SOP_ERR_STATUS_SHIFT (4U)
#define BRPHY_CORE_EXPF5_RX_SOP_OPTION_MASK (0x8U)
#define BRPHY_CORE_EXPF5_RX_SOP_OPTION_SHIFT (3U)
#define BRPHY_CORE_EXPF5_USE_RXDV_RX_SOP_MASK (0x4U)
#define BRPHY_CORE_EXPF5_USE_RXDV_RX_SOP_SHIFT (2U)
#define BRPHY_CORE_EXPF5_RECOVERY_CLK_SEL_MASK (0x2U)
#define BRPHY_CORE_EXPF5_RECOVERY_CLK_SEL_SHIFT (1U)
#define BRPHY_CORE_EXPF5_TIMESYNC_EN_MASK (0x1U)
#define BRPHY_CORE_EXPF5_TIMESYNC_EN_SHIFT (0U)
...
typedef volatile struct COMP_PACKED _BRPHY_CORE_RDBType {
    ...
    BRPHY_CORE_RESERVED_TYPE rsvd3[408]; /* OFFSET: 0x52 */
    BRPHY_CORE_EXPF5_TYPE expf5; /* OFFSET: 0x1ea */
    BRPHY_CORE_RESERVED_TYPE rsvd4[20]; /* OFFSET: 0x1ec */
} BRPHY_CORE_RDBType;


#define BRPHY1_GPHY_CORE_BASE           (0x490F2000UL)

#define BRPHY2_GPHY_CORE_BASE           (0x494F2000UL)

#define BRPHY3_GPHY_CORE_BASE           (0x498F2000UL)

#define BRPHY4_GPHY_CORE_BASE           (0x49CF2000UL)



#define BRPHY_CORE_MAX_HW_ID            (4UL)


#define BRPHY0_CORE_BASE                (BRPHY1_GPHY_CORE_BASE)


#define BRPHY1_CORE_BASE                (BRPHY2_GPHY_CORE_BASE)


#define BRPHY2_CORE_BASE                (BRPHY3_GPHY_CORE_BASE)


#define BRPHY3_CORE_BASE                (BRPHY4_GPHY_CORE_BASE)


#define BRPHY4_CORE_BASE                (UNDEFINED)
