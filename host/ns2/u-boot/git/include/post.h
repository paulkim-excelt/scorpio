...
#define BCM_NO_IP		3 /* For BCM Diags */
#define PEGASUS_XMC_BOARD	"pegasus_xmc"
#ifndef	__ASSEMBLY__
...
/* Added to support in Pegasus diags */
...
/* If USB_DIAGS_DEBUG macro is defined,
...
/* SATA Diags Support */
extern int do_scsi(cmd_tbl_t *cmdtp, int flag, int argc, char *const argv[]);
...
#else
/* Broadcom SOC diagnostics definitions */
#define CONFIG_SYS_POST_MEMORY			0x00000001
#define CONFIG_SYS_POST_UART			0x00000002
#define CONFIG_SYS_POST_QSPI			0x00000004
#define CONFIG_SYS_POST_BCM_SPI			0x00000008
#define CONFIG_SYS_POST_EMMC			0x00000010
#define CONFIG_SYS_POST_I2C			0x00000020
#define CONFIG_SYS_POST_NAND			0x00000040
#define CONFIG_SYS_POST_PCIE			0x00000080
#define CONFIG_SYS_POST_PWM			0x00000100
#define CONFIG_SYS_POST_I2S			0x00000200
#define CONFIG_SYS_POST_SPDIF			0x00000400
#define CONFIG_SYS_POST_USB			0x00000800
#define CONFIG_SYS_POST_SATA			0x00001000
#define CONFIG_SYS_POST_TAMPER			0x00002000
#define CONFIG_SYS_POST_LED			0x00004000
#define CONFIG_SYS_POST_USB20			0x00008000
#define CONFIG_SYS_POST_USB30			0x00010000
#define CONFIG_SYS_POST_USB20_DEVICE_MODE	0x00020000
#define CONFIG_SYS_POST_GMAC			0x00040000
#define CONFIG_SYS_POST_MDIO			0x00080000
