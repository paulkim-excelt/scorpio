...
static int nand_do_write_oob(struct mtd_info *mtd, loff_t to,
	...
	extern int nand_set_width_to_16_8(int, int);
#endif
					...
					int *busw)
{
	...
	if (chip->read_byte(mtd) != 'O' || chip->read_byte(mtd) != 'N' ||
		...
		printf("ONFI NAND_CMD_READID check failed.\n");
		return 0;
	}
		    ...
		    struct nand_flash_dev *table)
{
	...
	nand_set_defaults(chip, chip->options & NAND_BUSWIDTH_AUTO);
