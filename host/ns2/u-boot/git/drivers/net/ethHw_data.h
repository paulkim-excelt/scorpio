...
#define NICPM_IOMUX_CTRL_VAL_B0_10M (0x3196e000)
#define NICPM_IOMUX_CTRL_VAL_B0_100M (0x3196e400)
...
typedef struct bcmgmac_s {
	...
	struct gmacmib	mib;		/* mib statistic counters */
...
#define RCV_PKT_INFO_CRC_ERR_OFFSET (20)
#define RCV_PKT_INFO_RX_OVERFLOW    (23)
