...
#define RX_BUF(i)          (uint8_t *)(unsigned long)(RX_BUF_BASE + ((i) * RX_BUF_SIZE))
#define RX_DESC(i)         (dma64dd_t *)(unsigned long)(RX_DESC_BASE + ((i) * sizeof( dma64dd_t )))
...
#define TX_BUF(i)          (uint8_t *)(unsigned long)(TX_BUF_BASE + ((i) * TX_BUF_SIZE))
#define TX_DESC(i)         (dma64dd_t *)(unsigned long)(TX_DESC_BASE + ((i) * sizeof( dma64dd_t )))
