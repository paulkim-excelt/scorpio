...
typedef struct {
	...
	u32 addr;	/* descriptor ring base(4K aligned) */
...
/*
 * Each descriptor ring must be 4096byte aligned, and fit
 * within a single 4096byte page.
 */
...
#define	RC_FM		((u32)1 << 8)	/* direct fifo rx(pio) mode */
#define	RC_SH		((u32)1 << 9)	/* separate rx header desc en */
...
#define	RS_RE_BEDA	0x40000			/* bus error on desc access */
...
#define	FA_SEL_RSP	0xf0000			/* receive frame status ptrs */

/* descriptor control flags */
#define	CTRL_BC_MASK	0x00001fff		/* buf byte cnt, must <= 4KB */
...
typedef struct {
	...
	u32 addrlow;		/* memory address of the date buffer */
	u32 addrhigh;		/* memory address of the date buffer */
} dma64dd_t;
...
#define D64_XC_PC_4_DESCRIPTORS	0x1
#define D64_XC_PC_SHIFT		21
#define MAX_BURST_LEN		0x3
...
#define	D64_RC_FM		0x00000100	/* direct fifo rx (pio) mode */
#define	D64_RC_SH		0x00000200	/* separate rx header desc en */
...
#define DMA_CTRL_RXMULTI	(1 << 2)	/* rx scatter multiple descr */
#define DMA_CTRL_UNFRAMED	(1 << 3)	/* Unframed Rx/Tx data */
#define DMA_CTRL_USB_BOUNDRY4KB_WAR (1 << 4)	/* USB core REV9's  PR80468 */
...
#define	D64_FA_SEL_RSP		0xf0000		/* receive frame status ptrs */

/* descriptor control flags 1 */
#define D64_CTRL_COREFLAGS	0x0ff00000	/* core specific flags */
#define	D64_CTRL1_EOT		((u32)1 << 28)	/* end of desc table */
#define	D64_CTRL1_IOC		((u32)1 << 29)	/* int on completion */
#define	D64_CTRL1_EOF		((u32)1 << 30)	/* end of frame */
#define	D64_CTRL1_SOF		((u32)1 << 31)	/* start of frame */

/* descriptor control flags 2 */
#define	D64_CTRL2_BC_MASK	0x00007fff	/* buf byte cnt. must <= 16KB */
...
#define D64_RX_FRM_STS_DSCRCNT	0x0f000000	/* no. of desc used - 1, */
