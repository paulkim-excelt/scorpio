...
#define	CTL_SPEED_10	((0 << 6) | (0 << 13))	/* speed CTL.6=0, CTL.13=0 */
#define	CTL_SPEED_100	((0 << 6) | (1 << 13))	/* speed CTL.6=0, CTL.13=1 */
#define	CTL_SPEED_1000	((1 << 6) | (0 << 13))	/* speed CTL.6=1, CTL.13=0 */
