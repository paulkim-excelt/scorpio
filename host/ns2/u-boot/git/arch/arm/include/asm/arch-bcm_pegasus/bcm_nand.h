...
#define IPROC_NAND_WR_PREEMPT_EN                        0x01000000
#define IPROC_NAND_PARTIAL_PAGE_EN                      0x01000000
#define IPROC_NAND_ECC_READ_EN                          0x80000000
#define IPROC_NAND_ECC_WRITE_EN                         0x40000000
#define IPROC_NAND_FAST_PGM_RDIN                        0x10000000
...
void iproc_nand_device_param(uint8_t mnfc_id, uint8_t dev_id,
...
int iproc_nand_page_read(int cs, uint64_t page_addr, uint8_t *dst_addr,
			 uint32_t data_len);
int iproc_nand_page_program(int cs, uint64_t page_addr, uint8_t *src_addr,
			    uint32_t data_size);
