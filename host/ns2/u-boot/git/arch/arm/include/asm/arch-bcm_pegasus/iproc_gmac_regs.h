...
#define EMULATION_TEST 1
#define UNIMAC_LOOPBACK (0)
#define AMAC_DMA_LOOPBACK (0)
...
typedef volatile struct _gmacregs {
	...
	uint32_t		mib_pad[128];

	/* GAMC MIB counters */
	struct			gmacmib mib;		/* 0x300-0x428 */
	uint32_t		PAD[117];		/* 0x42c-0x7fc */
...
#define IPROC_GMAC0_REG_BASE		ETH_SS_0_AMAC_SS_AMAC0_DEVCONTROL
#define IPROC_GMAC1_REG_BASE		ETH_SS_0_AMAC_SS_AMAC1_DEVCONTROL
#define IPROC_GMAC2_REG_BASE		ETH_SS_0_AMAC_SS_AMAC2_DEVCONTROL
#define IPROC_GMAC3_REG_BASE		ETH_SS_0_AMAC_SS_AMAC3_DEVCONTROL

#define AMAC_IDM_RESET_CONTROL ETH_SS_0_AMAC_IDM_M0_IDM_RESET_CONTROL
#define AMAC_IDM2_IDM_RESET_CONTROL ETH_SS_0_AMAC_IDM_M2_IDM_RESET_CONTROL
#define AMAC_IDM3_IDM_RESET_CONTROL ETH_SS_0_AMAC_IDM_M3_IDM_RESET_CONTROL

#define AMAC_IDM3_IDM_IO_CONTROL ETH_SS_0_AMAC_IDM_M3_IO_CONTROL_DIRECT
#define AMAC_IDM0_IDM_IO_CONTROL ETH_SS_0_AMAC_IDM_M0_IO_CONTROL_DIRECT

#define GMAC_INTR_RECV_LAZY_OFFSET 0x30
#define GMAC_CHECKSUM_CTRL_OFFSET   0x400
#define GMAC_CHECKSUM_CTRL_REG		\
	(IPROC_GMAC3_REG_BASE + GMAC_CHECKSUM_CTRL_OFFSET)
/* CheckSum control fields */
#define CKSUM_CONTROL_HW_PSHDR_EN (1 << 8)
#define CKSUM_CONTROL_ACC_SS_MODE (1 << 7)
#define CKSUM_CONTROL_BRCM_HDR_EN (1 << 6)
#define CKSUM_CONTROL_SHIM_HDR_EN (1 << 5)
#define CKSUM_CONTROL_TSO_ENABLE (1 << 4)
#define CKSUM_CONTROL_LRO_HDR_LEN (1 << 6)
#define CKSUM_CONTROL_LRO_HDR_LEN_WIDTH (1 << 8)
#define CKSUM_CONTROL_LRO_META_LEN (1 << 8)
#define CKSUM_CONTROL_LRO_META_LEN_WIDTH (1 << 8)
#define CKSUM_CONTROL_LRO_ENABLED (1 << 7)
#define CKSUM_CONTROL_RMO_ENABLED (1 << 6)
#define CKSUM_CONTROL_CTF_BYPASS (1 << 5)
#define CKSUM_CONTROL_RXHDRCKSUMEN (1 << 4)
#define CKSUM_CONTROL_TXHDRCKSUMEN (1 << 3)
#define CKSUM_CONTROL_RXCKSUMMODE (1 << 2)
#define CKSUM_CONTROL_RXCKSUMEN (1 << 1)
#define CKSUM_CONTROL_TXCKSUMEN (1 << 0)


/* CTF registers */
#define CTF_CONTROL_OFFSET        0x20430c00
#define CTF_PORTS_CONFIG_OFFSET   0x20430dd8
#define CTF_PASS_TRU_PORT0_OFFSET 0x20430c08
#define CTF_PASS_TRU_PORT1_OFFSET 0x20430c0c
#define CTF_PASS_TRU_PORT2_OFFSET 0x20430c10
#define CTF_PASS_TRU_PORT3_OFFSET 0x20430c14

#define CTF_PORT3_UNIMAC_ENABLE (1<<8)

#define UNIMAC_CMD_CFG_VAL	0x6401b
/*
